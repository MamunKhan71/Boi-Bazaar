const ReadBooks = () => {
    ...
    return (
        <div className="flex gap-6 border rounded-2xl p-6">
            <div className="">
                <img className="max-h-72 bg-[#1313130d] rounded-2xl p-6" src="/images/rich-dad.png" alt="book-img"/>
            </div>
            <div className="w-full h-full space-y-4">
                <h1 className="text-4xl font-bold text-p[#131313] playFair">The Catcher in the Rye</h1>
                <p className="workSans text-xl font-medium text-[#131313cc]">By: Awlad Hossain</p>
                <div className="flex gap-3 workSans items-center">
                    ...
                    <div className="flex gap-2 items-center">
                        ...
                        <span className="text-[#13131399]">Year of Publishing: 1924</span>
                    </div>
                </div>
                <div className="flex gap-4 workSans">
                    <div className="flex gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path
                                ...
                                stroke="#131313" stroke-opacity="0.6" stroke-width="1.5" stroke-linecap="round"
                    ...
                    <div className="flex gap-2">
                        ...
                        <span className="text-[#13131399]">Page 192</span>
                    </div>
                </div>
                <hr/>
                <div className="flex gap-4">
                    <button className="text-lg btn rounded-full bg-[#328eff26] text-[#328EFF]">Category: Classic</button>
                    <button className="text-lg btn rounded-full bg-[#ffac3326] text-primaryColor">Rating: 4.5</button>
                    <button className="text-lg btn rounded-full bg-primaryColor text-white font-semibold">View Details</button>
                </div>
